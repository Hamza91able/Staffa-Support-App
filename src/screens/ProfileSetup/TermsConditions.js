            ...
            <Root>
                <View style={{ backgroundColor: '#FFA500', flex: 1, alignItems: 'center' }}>
                    <Grid>
                        ...
                        <Row size={70} style={{ backgroundColor: 'white', width: '90%' }}>
                            <Content>
                                <Item style={{ paddingLeft: 30, paddingRight: 30 }} inlineLabel>
                                    <Label>{this.state.TermsConditions}</Label>
                                </Item>
                            </Content>
                        </Row>
                        <Row size={12}>
                            <View style={{ alignItems: 'center', flex: 1, marginTop: '4%' }}>
                                <Body>
                                    <Button
                                        ...
                                        rounded><Text> Do Not Agree </Text>
                                    </Button>
                                </Body>
                            </View>
                        </Row>
                        <Row size={12}>
                            <View style={{ alignItems: 'center', flex: 1 }}>
                                <Body>
                                    <Button
                                        onPress={() => this.props.navigation.navigate('Privacy GPDR')}
                                        style={{ width: 180, justifyContent: 'center', backgroundColor: 'black' }}
